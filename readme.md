...
_%let gsconfigdir=/Yourconfigdir/Lev1/Applications/SASGridManagerClientUtility/9.4; /*for mygsub macro, be sure to update your sasgsub.cfg to not prompt for password */  
